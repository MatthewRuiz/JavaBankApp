...
CREATE TABLE `bank_user` (
  ...
  KEY `status` (`status`),
  CONSTRAINT `bank_user_ibfk_1` FOREIGN KEY (`status`) REFERENCES `user_status` (`name`)
...
INSERT INTO `bank_user` VALUES (1,'Matthew','12345','mruiz@test.com','ACTIVE'),(2,'Chooch','yeet','chooch@chooch.com','ACTIVE');
...
-- Dump completed on 2019-06-09 14:16:53
